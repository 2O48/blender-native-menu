...
static void wm_native_menu_update_items(bContext *C, wmWindow *win)
{
  ...
  blender::Vector<ui::UINativeMenuItem> ui_items;
  ui::UI_menutype_native_items_collect(C, editor_menus, ui_items, 0);

  static std::string last_signature;
  std::string signature;
  for (ui::UINativeMenuItem &item : ui_items) {
  ...
  for (const ui::UINativeMenuItem &item : ui_items) {
  ...
  if (!native_items.is_empty()) {
    g_system->updateNativeMenu(native_items.data(), native_items.size());
  }
  CTX_wm_window_set(C, prev_win);
#else
  UNUSED_VARS(C, win);
...
static void wm_native_menu_exec_command(bContext *C, wmWindowManager *wm, wmWindow *win, const char *command)
{
  ...
  if (STRPREFIX(command, "OP:")) {
    wm_native_menu_call_operator(C, command + 3, wm::OpCallContext::InvokeDefault);
  }
    ...
    WM_menu_name_call(C, command + 5, wm::OpCallContext::InvokeDefault);
  }
    ...
    wm_native_menu_call_operator(C,
                                 "WM_OT_save_mainfile",
                                 STREQ(command, "CMD:SAVE_INCREMENTAL") ?
    ...
    wm_native_menu_call_operator(C, "WM_OT_save_as_mainfile", wm::OpCallContext::InvokeDefault, &props);
    WM_operator_properties_free(&props);
  }
    ...
    wm_native_menu_call_operator(C, "WM_OT_read_homefile", wm::OpCallContext::InvokeDefault, &props);
    WM_operator_properties_free(&props);
  }
    ...
    wm_native_menu_call_operator(C, "RENDER_OT_render", wm::OpCallContext::InvokeDefault, &props);
    WM_operator_properties_free(&props);
  }
    ...
    wm_native_menu_call_operator(C, "WM_OT_call_panel", wm::OpCallContext::InvokeDefault, &props);
    WM_operator_properties_free(&props);
  }
    ...
    wm_native_menu_call_operator(C, "SCREEN_OT_workspace_cycle", wm::OpCallContext::InvokeDefault, &props);
    WM_operator_properties_free(&props);
  }
    ...
    wm_native_menu_call_operator(C, opstring, wm::OpCallContext::InvokeDefault, &props);
    WM_operator_properties_free(&props);
  }
